...
/*CREATE PROCEDURE CLINIC.INSERT_ROW_OC_PERSON 
	@CNIC NUMERIC, @FIRST_NAME VARCHAR(30), @LAST_NAME VARCHAR(30), @ADDRESS VARCHAR(100), @AGE NUMERIC(2), @GENDER VARCHAR(1), @DOB DATE, @NATIONALITY VARCHAR(30), @EMAIL VARCHAR(30)
AS
BEGIN
...
/*CREATE PROCEDURE CLINIC.INSERT_ROW_OC_DOCTOR
	@CNIC NUMERIC, @QUALIFICATION TEXT, @SPECIALIZATION TEXT, @FEE NUMERIC
AS
BEGIN
