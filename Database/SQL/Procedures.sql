...
/*CREATE PROCEDURE DELETE_ROW_OC_PATEINT @PAT_ID NUMERIC
AS
...
AS
	...
	IF EXISTS (SELECT * FROM OC_DOCTOR WHERE DOC_ID = @DOC_ID) OR EXISTS (SELECT * FROM OC_DOCTOR_HISTORY WHERE DOC_ID = @DOC_ID)
	BEGIN
